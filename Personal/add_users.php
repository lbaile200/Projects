...
$sql = "INSERT INTO main (user, init1, effects, status, damage_done, damage_taken, RealUser, DM) VALUES ('$user', '$init', '$effects', '$status', '$damage_done', '$damage_taken', '$realuser', '$isdm')";
