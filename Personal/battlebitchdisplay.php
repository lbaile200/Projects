...
$result = mysqli_query($con,"SELECT RealUser, user, init1, effects, status, damage_done, damage_taken FROM main ORDER BY init1 desc");
...
echo "<td><div contenteditable='true' tabindex='3'>" . $row['init1'] . "</div></td>";
...
<!--BEGIN DICE ROLLER FUNCTION D4--D20  Need coinflip and d100-->
