...
$result = mysqli_query($con,"SELECT Item_Type, Item_Name, Item_Price_Out, Carrier FROM Inventory ORDER BY Carrier DESC");
...
{
echo "<tr>";
echo "<td><div contenteditable='False' tabindex='1'>" . $row['Item_Type'] . "</div></td>";
echo "<td><div contenteditable='False' tabindex='2'>" . $row['Item_Name'] . "</div></td>";
echo "<td><div contenteditable='False' tabindex='3'>" . $row['Item_Price_Out'] . "</div></td>";
echo "<td><div contenteditable='False' tabindex='4'>" . $row['Carrier'] . "</div></td>";
